    ...
    <div class="m-action-buttons">
        <div class="c-button">
            <button @click="add" type="button" class="el-button el-button--primary is-circle">
                <svg class="icon-add" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 414.3 414.3">
        ...
        <div class="c-button">
            ...
            <button @click="resetMarks" type="button" class="el-button el-button--primary is-circle">
                <svg class="icon-zero" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 453.7 453.7">
        ...
        <div class="c-button">
            <button @click="resetWheel" type="button" class="el-button el-button--primary is-circle">
                <svg class="icon-reset" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 487.4 487.4">
        ...
        <div class="c-button">
            <button @click="download" type="button" class="el-button el-button--primary is-circle">
                <svg class="icon-image" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 446.3 446.3">
